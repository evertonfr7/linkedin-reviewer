...
export default function ProfileSnapshot({ profile, profilePhoto }: ProfileSnapshotProps) {
  const photoSrc = profilePhoto || profile.photoUrl;
      ...
      <div className="mt-4 pt-4 border-t border-outline-variant">
        <div className="flex flex-wrap gap-3">
          ...
          <div className="flex items-center gap-1.5 text-sm text-on-surface-variant">
            ...
            <span>{profile.recommendationsReceived} recommendations</span>
          </div>
          ...
          {profile.certifications.length > 0 && (
            <div className="flex items-center gap-1.5 text-sm text-on-surface-variant">
              ...
              <span>{profile.certifications.length} certifications</span>
            </div>
          )}
        </div>
      </div>
